---
title: Getting Started with Assets Loader
description: Query Cloudinary assets in Astro with Collections.
head:
  - tag: title
    content: Assets Loader - Astro Cloudinary
---
import { CldImage } from '../../../../../astro-cloudinary';

import CodeBlock from '../../../components/CodeBlock.astro';
import HeaderImage from '../../../components/HeaderImage.astro';
import DemoAssetsLoader from '../../../components/DemoAssetsLoader.astro';
