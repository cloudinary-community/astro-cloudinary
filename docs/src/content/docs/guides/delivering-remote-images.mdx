...
The Fetch API allows you to deliver remote images on-the-fly through Cloudinary, applying transformations as needed. This method is ideal for dynamically accessing and transforming images from external sources without storing them in your Cloudinary account.
...
```
https://res.cloudinary.com/demo/image/fetch/https://upload.wikimedia.org/wikipedia/commons/4/47/PNG_transparency_demonstration_1.png
```
...
```
https://res.cloudinary.com/demo/image/fetch/c_thumb,e_sepia,f_auto,g_auto,h_300,q_auto,w_300/https://upload.wikimedia.org/wikipedia/commons/4/47/PNG_transparency_demonstration_1.png
```
...
This process happens on-the-fly, allowing you to apply Cloudinary's transformations and optimizations to any image on the web without storing it in your account.
...
- Use **Fetch API** when:
  - You need to dynamically access and transform images without storing them.
