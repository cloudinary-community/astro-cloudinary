...
:::note
CldImage supports all of [the standard HTML `img` attributes](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/img#attributes) as props and passes them to the underlying `img`.
:::

:::tip
CldImage lazy-loads by default. See the [Image Performance and LCP guide](/guides/image-performance-lcp) to learn how to load critical, above-the-fold images eagerly, instead.
:::
