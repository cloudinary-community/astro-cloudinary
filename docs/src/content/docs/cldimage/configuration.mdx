...
:::tip
CldImage supports all standard HTML image attributes. For performance optimization, see [`fetchpriority`](#fetchpriority) and [`loading`](#loading) below.
:::
  ...
  data={[
    {
      ...
      more: () => (<a href="https://developer.mozilla.org/en-US/docs/Web/API/HTMLImageElement/alt#usage_notes">More Info</a>)
    },
    {
      prop: 'height',
      type: 'number/string',
      ...
      more: () => (<a href="https://developer.mozilla.org/en-US/docs/Web/API/HTMLImageElement/height">More Info</a>)
    },
    {
      prop: 'src',
      type: 'string',
    ...
    },
    {
      ...
      required: () => (<span>Yes</span>),
      example: () => (<code>600</code>),
      more: () => (<a href="https://developer.mozilla.org/en-US/docs/Web/API/HTMLImageElement/width">More Info</a>)
    },
  ]}
/>
...
<Table
  ...
  data={[
    ...
    },
    {
      ...
      default: '-',
      example: () => (<code>{`true`}</code>),
      more: () => (<a className="whitespace-nowrap" href="https://cloudinary.com/documentation/transformation_reference#e_gen_background_replace">More Info</a>)
    },
    {
      prop: 'restore',
      type: 'boolean',
...
<Table
  ...
  data={[
    ...
    },
    {
      ...
      type: 'string',
      default: '-',
      example: () => (<code>Astro Cloudinary</code>),
    },
    {
      prop: 'underlay',
      type: 'string',
...
<Table
  ...
  data={[
    ...
    },
    {
      prop: 'text',
      type: 'object|string',
      example: () => (<span><code>Astro Cloudinary</code> or See <a href="#layer-text-props">text</a> Below</span>),
    },
    {
      prop: 'url',
      type: 'string',
...
CldImage supports standard HTML image attributes for controlling loading behavior and prioritization.
  ...
  data={[
    {
      ...
      type: 'string',
      default: () => (<code>auto</code>),
      example: () => (<code>high</code>),
      more: () => (<a className="whitespace-nowrap" href="https://developer.mozilla.org/en-US/docs/Web/API/HTMLImageElement/fetchPriority">More Info</a>)
    },
    {
      prop: 'loading',
      type: 'string',
      default: () => (<code>lazy</code>),
      example: () => (<code>eager</code>),
      more: () => (<a className="whitespace-nowrap" href="https://developer.mozilla.org/en-US/docs/Web/API/HTMLImageElement/loading">More Info</a>)
    },
  ]}
/>
...
Provides a hint to the browser about the relative priority of fetching the image.

Use `fetchpriority="high"` for images that are critical to page load, such as hero images or other above-the-fold content that impacts [Largest Contentful Paint (LCP)](/guides/image-performance-lcp).
...
:::caution
Only prioritize one or two critical images per page. Over-using `fetchpriority="high"` can hurt performance.
:::

[Learn more about fetchPriority](https://developer.mozilla.org/en-US/docs/Web/API/HTMLImageElement/fetchPriority) on MDN.

#### `loading`

Controls when the browser should load the image.

By default, CldImage uses `loading="lazy"` to defer loading of off-screen images. For critical images visible on initial page load, use `loading="eager"` in combination with `fetchpriority="high"`.

**Examples**

Disable lazy loading for a critical image:
...
[Learn more about loading](https://developer.mozilla.org/en-US/docs/Web/API/HTMLImageElement/loading) on MDN.

:::tip
Learn more about optimizing image performance in the [Image Performance & LCP guide](/guides/image-performance-lcp).
:::