...
<strong class="block mt-8 mb-2 text-lg text-slate-700 font-medium">Remove Background</strong>
...
<strong class="block mt-8 mb-2 text-lg text-slate-700 font-medium">Color Background</strong>
...
<strong class="block mt-8 mb-2 text-lg text-slate-700 font-medium">Image Background</strong>
...
<strong class="block mt-8 mb-2 text-lg text-slate-700 font-medium">Cropping</strong>
