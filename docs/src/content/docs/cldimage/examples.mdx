...
<HeaderImage>
  <CldImage
    src={`${import.meta.env.PUBLIC_ASSETS_DIRECTORY}/sneakers`}
    width="960"
    height="600"
    crop="fill"
...
<HeaderImage>
  <CldImage
    src={`${import.meta.env.PUBLIC_ASSETS_DIRECTORY}/mountain`}
    width="960"
    height="600"
    crop="fill"
    remove="mountain"
...
<HeaderImage>
  <CldImage
    src={`${import.meta.env.PUBLIC_ASSETS_DIRECTORY}/turtle`}
    width="960"
    height="600"
    crop="fill"
...
<HeaderImage layout="grid">
  <CldImage
    src={`${import.meta.env.PUBLIC_ASSETS_DIRECTORY}/galaxy-poor`}
    width="960"
    height="600"
    crop="fill"
    alt=""
...
<HeaderImage>
  <CldImage
    ...
    sizes="100vw"
    overlays={[{
      publicId: `${import.meta.env.PUBLIC_ASSETS_DIRECTORY}/earth`,
      position: {
        x: 50,
        y: 50,
        gravity: 'north_west',
...
<HeaderImage>
  <CldImage
    ...
    height="600"
    crop="fill"
    src={`${import.meta.env.PUBLIC_ASSETS_DIRECTORY}/galaxy`}
    overlays={[{
