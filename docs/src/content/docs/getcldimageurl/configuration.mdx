...
description: Options and configuration for getCldImageUrl in Astro.
head:
  - tag: title
    content: getCldImageUrl Configuration - Astro Cloudinary
---
...
:::tip
Note: Configuration for getCldImageUrl is the same as [CldImage](/cldimage/configuration), which both use the same underlying API.
:::
