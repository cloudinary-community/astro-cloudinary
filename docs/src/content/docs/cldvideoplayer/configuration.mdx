  ...
  data={[
    {
      ...
      default: '-',
      example: ' ',
      more: () => (<a href="https://cloudinary.com/documentation/video_player_api_reference#video_config">More Info</a>)
    },
    {
      prop: 'transformation',
  ...
  data={[
    {
      ...
      default: '-',
      example: ' ',
      more: () => (<a href="https://cloudinary.com/documentation/video_player_api_reference#adsprops">More Info</a>)
    },
    {
      prop: 'analytics',
      type: 'boolean',
      default: 'false',
      example: 'true',
      more: () => (<a href="https://cloudinary.com/documentation/video_player_api_reference#ads_and_analytics">More Info</a>)
    },
    {
  ...
  data={[
    {
      ...
      default: '-',
      example: 'pt',
      more: () => (<a href="https://cloudinary.com/documentation/video_player_api_reference">More Info</a>)
    },
    {
      prop: 'languages',
      type: 'object',
      ...
      more: () => (<a href="https://videojs.com/guides/languages/#json-format">More Info</a>)
    },
  ]}
/>
...
<Table
  ...
  data={[
    ...
    },
    {
      ...
      default: 'false',
      example: 'true',
      more: () => (<a href="https://cloudinary.com/documentation/video_player_api_reference#player_behavior">More Info</a>)
    },
    {
      prop: 'loop',
      type: 'boolean',
